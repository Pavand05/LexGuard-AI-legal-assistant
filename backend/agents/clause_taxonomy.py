...
CANONICAL_CLAUSE_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EMPLOYMENT_TERM": {
        ...
        "dimension": "Legal",
        "default_risk": "low",
        "aliases": ["employment term", "period of employment", "employment period", "term of employment", "appointment duration", "tenure"],
    ...
    "POSITION_DUTIES": {
        ...
        "default_risk": "low",
        "aliases": ["duties & position", "position & duties", "job title", "responsibilities", "duties", "reporting structure", "scope of employment"],
        "primary_domains": ["EMPLOYMENT_LABOR"]
    },
    "COMPENSATION_BENEFITS": {
        ...
        "dimension": "Financial",
        "default_risk": "medium",
        "aliases": ["compensation & benefits", "compensation", "salary", "annual ctc", "base salary", "bonus", "benefits", "equity incentives", "stock options", "vesting", "allowances"],
        "primary_domains": ["EMPLOYMENT_LABOR"]
    },
    "NON_COMPETE": {
        ...
        "dimension": "Legal",
        "default_risk": "high",
        "aliases": ["non-compete & restraint", "non-compete", "non-competition", "covenant not to compete", "restrictive covenants", "restraint of trade"],
    ...
    "NON_SOLICITATION": {
        ...
        "dimension": "Operational",
        "default_risk": "medium",
        "aliases": ["non-solicitation", "non-solicit", "solicitation of clients", "solicitation of employees", "no-poach"],
    ...
    "SEVERANCE_WAIVER": {
        ...
        "dimension": "Financial",
        "default_risk": "medium",
        "aliases": ["severance", "separation pay", "release of claims", "general release", "waiver of claims", "waiver and release"],
        "primary_domains": ["EMPLOYMENT_LABOR"]
    },
    "COOPERATION_HANDOVER": {
        ...
        "dimension": "Operational",
        "default_risk": "low",
        "aliases": ["executive cooperation", "cooperation", "return of company property", "company property in possession", "handover of assets"],
    ...
    "PROPERTY_DESCRIPTION": {
        ...
        "dimension": "Legal",
        "default_risk": "low",
        "aliases": ["property description & schedule", "schedule of property", "schedule property", "demised premises", "survey number", "khata", "land description"],
    ...
    "TITLE_OWNERSHIP": {
        ...
        "dimension": "Legal",
        "default_risk": "high",
        "aliases": ["title & ownership", "marketable title", "absolute owner", "chain of title", "ownership rights", "title history", "hereditary rights"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "POSSESSION_REAL_ESTATE": {
        ...
        "dimension": "Operational",
        "default_risk": "medium",
        "aliases": ["possession", "vacant possession", "physical possession", "handover of possession", "delivery of possession"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "ENCUMBRANCE_MORTGAGE": {
        ...
        "dimension": "Financial",
        "default_risk": "high",
        "aliases": ["encumbrance & mortgage", "mortgage", "free from all encumbrances", "hypothecation", "court attachment", "lis pendens", "charge on property"],
    ...
    "CONSIDERATION_PAYMENT": {
        ...
        "dimension": "Financial",
        "default_risk": "medium",
        "aliases": ["consideration & payment", "sale consideration", "earnest money", "advance token", "balance consideration", "purchase price", "pricing & payment"],
    ...
    "LEASE_TERM_RENEWAL": {
        ...
        "dimension": "Legal",
        "default_risk": "medium",
        "aliases": ["lease term & renewal", "lease term", "term of lease", "ground lease tenure", "lease renewal", "tenancy term"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "SUBLEASE_ASSIGNMENT": {
        ...
        "dimension": "Legal",
        "default_risk": "high",
        "aliases": ["assignment & sublease", "sublease", "sublet", "subletting", "assignment of lease", "prohibition on subleasing"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "PERMITTED_USE_RESTRICTIONS": {
        ...
        "dimension": "Operational",
        "default_risk": "medium",
        "aliases": ["permitted use & restrictions", "permitted use", "use of demised premises", "operational restrictions", "construction restrictions"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "REGISTRATION_STAMP_DUTY": {
        ...
        "default_risk": "medium",
        "aliases": ["registration & stamp duty", "stamp duty", "sub-registrar", "registration fee", "stamp paper"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "TAXES_OUTGOINGS": {
        ...
        "dimension": "Financial",
        "default_risk": "low",
        "aliases": ["taxes & outgoings", "property tax", "betterment charges", "municipal taxes", "statutory outgoings"],
        "primary_domains": ["REAL_ESTATE"]
    },
    "DEFAULT_FORFEITURE": {
        ...
        "dimension": "Legal",
        "default_risk": "high",
        "aliases": ["default & forfeiture", "earnest money forfeiture", "forfeiture of deposit", "specific performance remedies"],
    ...
    "CONFIDENTIALITY_NDA": {
        ...
        "dimension": "Legal",
        "default_risk": "medium",
        "aliases": ["confidentiality", "confidentiality & non-disclosure", "definition of confidential information", "trade secrets", "non-disclosure"],
    ...
    "IP_ASSIGNMENT": {
        ...
        "dimension": "IP",
        "default_risk": "high",
        "aliases": ["intellectual property", "intellectual property assignment", "ip ownership", "work made for hire", "inventions assignment", "proprietary rights"],
    ...
    "LICENSE_GRANT": {
        ...
        "dimension": "Legal",
        "default_risk": "medium",
        "aliases": ["license grant & scope", "grant of license", "license scope", "authorized users", "permitted seats"],
    ...
    "SLA_SERVICE_LEVEL": {
        ...
        "dimension": "Operational",
        "default_risk": "medium",
        "aliases": ["sla & uptime commitments", "service level agreement", "sla", "uptime commitment", "service credits"],
        "primary_domains": ["IP_SOFTWARE_TECH"]
    },
    ...
    "DATA_PROTECTION_PRIVACY": {
        ...
        "dimension": "Privacy",
        "default_risk": "high",
        "aliases": ["data protection & security", "data protection & privacy", "data privacy", "personal data processing", "security safeguards", "breach notification"],
    ...
    "TERMINATION_NOTICE": {
        ...
        "dimension": "Operational",
        "default_risk": "medium",
        "aliases": ["termination", "termination & notice period", "term and termination", "termination for cause", "termination for convenience", "notice period"],
    ...
    "INDEMNITY_LIABILITY": {
        ...
        "dimension": "Financial",
        "default_risk": "high",
        "aliases": ["indemnity & liability", "indemnity", "indemnification", "limitation of liability", "liability cap", "consequential damages exclusion", "hold harmless"],
    ...
    "GOVERNING_LAW_JURISDICTION": {
        ...
        "dimension": "Legal",
        "default_risk": "low",
        "aliases": ["governing law & jurisdiction", "governing law", "jurisdiction", "applicable law", "choice of law", "court jurisdiction"],
    ...
    "DISPUTE_RESOLUTION_ARBITRATION": {
        ...
        "dimension": "Legal",
        "default_risk": "medium",
        "aliases": ["dispute resolution & jurisdiction", "dispute resolution & arbitration", "arbitration", "dispute resolution", "arbitral seat", "mediation"],
    ...
    "REPRESENTATIONS_WARRANTIES": {
        ...
        "dimension": "Legal",
        "default_risk": "medium",
        "aliases": ["representations & warranties", "reps & warranties", "warranties", "covenants and warranties"],
    ...
    "NOTICES_COMMUNICATIONS": {
        ...
        "dimension": "Operational",
        "default_risk": "low",
        "aliases": ["notices & formal communications", "notices", "formal notice", "addresses for notice"],
